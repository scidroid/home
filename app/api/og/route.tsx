...
export async function GET(request: Request) {
  ...
  const [fontRegular, fontBold, headshotPng] = await Promise.all([
    ...
    sharp(join(process.cwd(), "public/juan.webp"))
  ...
  const fonts = [
    { name: "Onest", data: fontRegular, weight: 400 as const, style: "normal" as const },
    { name: "Onest", data: fontBold, weight: 700 as const, style: "normal" as const },
  ];
      ...
      (
        <div
          style={{
            ...
            display: "flex",
            flexDirection: "row",
            background: "linear-gradient(145deg, #f8fafc 0%, #eff6ff 50%, #f0fdf4 100%)",
          }}
        >
          {/* Left — accent strip */}
          <div
