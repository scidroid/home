...
Inspired in the implementations of [Roger](https://codeforces.com/profile/ahoraSoyPeor) and [Oscar](https://codeforces.com/profile/mcqueencin) for the [Sereja and Brackets](https://codeforces.com/problemset/problem/380/C) problem.

```cpp:segment-tree.cpp
struct info {
    ll ans = 0;
    ll open = 0;
    ll closed = 0;
